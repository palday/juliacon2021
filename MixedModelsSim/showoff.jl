...
@bind s_subj_intercept Slider(0:10, 1, true)
...
@bind s_subj_context Slider(0:10, 1, true)
...
@bind s_subj_frequency Slider(0:10, 1, true)
...
@bind s_subj_interaction Slider(0:10, 1, true)
...
@bind s_item_intercept Slider(0:10, 1, true)
...
@bind s_item_context Slider(0:10, 1, true)
